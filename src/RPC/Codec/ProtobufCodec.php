...
use KCTLD\Google\Protobuf\Internal\Message;
...
final class ProtobufCodec implements CodecInterface
{
     ...
     * @var string
     */
    private const ERROR_DEPENDENCY = 'Could not initialize protobuf codec. ' . 'Please add "ext-protobuf" PECL extension or ' . 'install "google/protobuf" Composer dependency.';
    ...
    {
        if (\is_string($options) && \is_subclass_of($options, Message::class, \true)) {
