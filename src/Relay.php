...
use KCTLD\Spiral\Goridge\Exception\RelayFactoryException;
    ...
    public static function create(string $connection) : RelayInterface
    {
        ...
        switch ($protocol) {
            ...
            case self::UNIX_SOCKET:
                $socketType = $protocol === self::TCP_SOCKET ? SocketRelay::SOCK_TCP : SocketRelay::SOCK_UNIX;
                $port = isset($match['arg2']) ? (int) $match['arg2'] : null;
